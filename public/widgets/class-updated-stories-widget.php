...
class Mooberry_Story_Community_Updated_Stories_Widget extends WP_Widget {
	...
	//	$stories = Mooberry_Story_Community_Factory_Generator::create_story_factory()->create_story_collection()::get_recently_updated_stories($limit );
		global $mbdsc_story_factory;
		$stories = $mbdsc_story_factory->create_story_collection()::get_recently_updated_stories($limit );
