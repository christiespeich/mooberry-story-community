	...
	public function register() {
		...
		$defaults = array(
			...
			'labels'            => array(
				...
				'archives'                 => sprintf( __( '%s Archives', 'mooberry-story-community' ), $this->plural_name ),
				'insert_into_item'         => sprintf( __( 'Insert into %s', 'mooberry-story-community' ), $this->singular_name ),
				'uploaded_to_this_item'    => sprintf( __( 'Uploaded to this %s', 'mooberry-story-community' ), $this->singular_name ),
				'item_published'           => sprintf( __( '%s Published', 'mooberry-story-community' ), $this->singular_name ),
				'item_published_privately' => sprintf( __( '%s Published Privately', 'mooberry-story-community' ), $this->singular_name ),
				'item_reverted_to_draft'   => sprintf( __( '%s Reverted to Draft', 'mooberry-story-community' ), $this->singular_name ),
				'item_scheduled'           => sprintf( __( '%s Scheduled', 'mooberry-story-community' ), $this->singular_name ),
				'item_link'                => sprintf( __( '%s Link', 'mooberry-story-community' ), $this->singular_name ),
				'item_link_description'    => sprintf( __( 'A Link to a %s', 'mooberry-story-community' ), $this->singular_name ),
